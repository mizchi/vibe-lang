...
use vibe_core::{parser, Expr, Type, XsError};
use vibe_workspace::{
    database::{XsDatabaseImpl, SourcePrograms, XsDatabase, CompilerQueries},
...
fn benchmark_cache_based(expr: &Expr, iterations: u32) -> Result<BenchmarkResult> {
