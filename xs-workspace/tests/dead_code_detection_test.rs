...
fn setup_complex_codebase(repo: &mut CodeRepository) {
    ...
    let dead2_term = Term {
        ...
        expr: xs_core::Expr::Literal(xs_core::Literal::Int(5), xs_core::Span::new(0, 1)),
        ty: xs_core::Type::Int,
    ...
    let test_term = Term {
        ...
        expr: xs_core::Expr::Literal(xs_core::Literal::Int(6), xs_core::Span::new(0, 1)),
        ty: xs_core::Type::Int,
        dependencies: HashSet::new(),
    };
