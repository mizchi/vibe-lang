...
mod tests {
    ...
    fn test_deterministic_hashing() {
        let content = DefinitionContent::Value(Expr::Literal(Literal::Int(42), xs_core::Span::new(0, 0)));
        let ty = Type::Int;
    ...
    fn test_different_content_different_hash() {
        let content1 = DefinitionContent::Value(Expr::Literal(Literal::Int(42), xs_core::Span::new(0, 0)));
        let content2 = DefinitionContent::Value(Expr::Literal(Literal::Int(43), xs_core::Span::new(0, 0)));
        let ty = Type::Int;
