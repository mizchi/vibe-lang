//! Package management for Vibe language
//!
//! This module provides functionality for managing Vibe packages,
//! including manifest handling, caching, registry access, and dependency resolution.
