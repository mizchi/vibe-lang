...
function printIdeUsage() {
  console.log("xsh ide <outline|peek-def|search> ...");
  console.log("  xsh ide outline <file>");
  console.log("  xsh ide peek-def <symbol> <file>");
  console.log("  xsh ide search <query> <file>");
}
