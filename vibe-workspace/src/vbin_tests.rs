...
mod tests {
    ...
    fn create_test_codebase() -> Codebase {
        ...
        // Add some terms
        let expr1 = vibe_core::Expr::Literal(vibe_core::Literal::Int(42), vibe_core::Span::new(0, 2));
        let _hash1 = codebase.add_term(Some("answer".to_string()), expr1, vibe_core::Type::Int).unwrap();
        
        let expr2 = vibe_core::Expr::Lambda {
            params: vec![(vibe_core::Ident("x".to_string()), Some(vibe_core::Type::Int))],
            body: Box::new(vibe_core::Expr::Ident(vibe_core::Ident("x".to_string()), vibe_core::Span::new(0, 1))),
            span: vibe_core::Span::new(0, 10),
        };
        let _hash2 = codebase.add_term(
            Some("identity".to_string()), 
            expr2, 
            vibe_core::Type::Function(Box::new(vibe_core::Type::Int), Box::new(vibe_core::Type::Int))
        ).unwrap();
        
        // Add dependency
        let expr3 = vibe_core::Expr::Apply {
            func: Box::new(vibe_core::Expr::Ident(vibe_core::Ident("identity".to_string()), vibe_core::Span::new(0, 8))),
            args: vec![vibe_core::Expr::Ident(vibe_core::Ident("answer".to_string()), vibe_core::Span::new(0, 6))],
    ...
    fn test_vbin_compression() {
        ...
        let mut codebase = Codebase::new();
        for i in 0..100 {
            let expr = vibe_core::Expr::Literal(
                vibe_core::Literal::Int(i), 
        ...
        assert!(vbin_size < bin_size, "VBin size {} should be less than binary size {}", vbin_size, bin_size);
    }
    ...
    fn test_retrieve_namespace() {
        ...
        codebase.add_term(
            ...
            vibe_core::Expr::Literal(vibe_core::Literal::String("".to_string()), vibe_core::Span::new(0, 2)),
