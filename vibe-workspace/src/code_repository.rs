...
mod tests {
    ...
    fn test_store_and_retrieve_term() {
        ...
        // Create a test term
        let expr = vibe_core::Expr::Literal(vibe_core::Literal::Int(42), vibe_core::Span::new(0, 2));
    ...
    fn test_dependencies() {
        ...
        let term2 = Term {
            ...
            expr: vibe_core::Expr::Ident(vibe_core::Ident("base".to_string()), vibe_core::Span::new(0, 4)),
            ty: vibe_core::Type::Int,
    ...
    fn test_dead_code_removal() {
        ...
        let dead_term = Term {
            ...
            expr: vibe_core::Expr::Literal(vibe_core::Literal::Int(666), vibe_core::Span::new(0, 3)),
            ty: vibe_core::Type::Int,
            dependencies: HashSet::new(),
        };
