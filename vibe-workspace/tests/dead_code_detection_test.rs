...
fn setup_complex_codebase(repo: &mut CodeRepository) {
    ...
    let helper_hash =
        Hash::from_hex("3333333333333333333333333333333333333333333333333333333333333333").unwrap();
    ...
    let dead1_hash =
        Hash::from_hex("4444444444444444444444444444444444444444444444444444444444444444").unwrap();
    let dead1_term = Term {
    ...
    let dead2_hash =
        Hash::from_hex("5555555555555555555555555555555555555555555555555555555555555555").unwrap();
    let dead2_term = Term {
    ...
    let test_hash =
        Hash::from_hex("6666666666666666666666666666666666666666666666666666666666666666").unwrap();
    let test_term = Term {
...
fn test_multiple_namespace_reachability() {
    ...
    let analysis = repo
        .analyze_reachability(&["Main".to_string(), "Test".to_string()])
        .unwrap();
...
fn test_circular_dependencies() {
    ...
    let a_hash =
        Hash::from_hex("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa").unwrap();
    let b_hash =
        Hash::from_hex("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb").unwrap();
    let c_hash =
        Hash::from_hex("cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc").unwrap();
    ...
    let analysis = repo
        .analyze_reachability(&["Circular".to_string()])
        .unwrap();
...
fn test_empty_namespace_analysis() {
    ...
    let analysis = repo
        .analyze_reachability(&["NonExistent".to_string()])
        .unwrap();
