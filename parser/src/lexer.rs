...
impl<'a> Lexer<'a> {
    ...
    fn read_string(&mut self) -> Result<Option<(Token, Span)>, XsError> {
        ...
        while let Some(&ch) = self.chars.peek() {
            if ch == '"' {
                self.advance();
                return Ok(Some((Token::String(value), Span::new(start, self.position))));
            } else if ch == '\\' {
                self.advance();
                match self.chars.peek() {
                    Some(&'n') => {
        ...
        Err(XsError::ParseError(start, "Unterminated string".to_string()))
    }
...
mod tests {
    ...
    fn test_basic_tokens() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Some((Token::LeftParen, Span::new(0, 1))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::RightParen, Span::new(2, 3))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Colon, Span::new(4, 5))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Arrow, Span::new(6, 8))));
    ...
    fn test_numbers() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Int(42), Span::new(0, 2))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Int(-17), Span::new(3, 6))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Int(0), Span::new(7, 8))));
    }
    ...
    fn test_strings() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Some((Token::String("hello".to_string()), Span::new(0, 7))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::String("world\n".to_string()), Span::new(8, 17))));
    }
    ...
    fn test_symbols_and_keywords() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Let, Span::new(0, 3))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Lambda, Span::new(4, 10))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::If, Span::new(11, 13))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Symbol("+".to_string()), Span::new(14, 15))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Symbol("-".to_string()), Span::new(16, 17))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Symbol("foo-bar".to_string()), Span::new(18, 25))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Bool(true), Span::new(26, 30))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Bool(false), Span::new(31, 36))));
    }
    ...
    fn test_comments() {
        ...
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Int(42), Span::new(0, 2))));
        assert_eq!(lexer.next_token().unwrap(), Some((Token::Int(43), Span::new(23, 25))));
    }
}