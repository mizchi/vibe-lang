...
OK_REPORT="$(bash "$SCRIPT_DIR/run_check_preview2_component.sh" "$COMPONENT_PATH" "$OK_INPUT")"
ERR_REPORT="$(bash "$SCRIPT_DIR/run_check_preview2_component.sh" "$COMPONENT_PATH" "$ERR_INPUT")"
