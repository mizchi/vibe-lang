...
EXTRA_ENTRIES="${VIBE_SELFHOST_SUITE_EXTRA_ENTRIES:-vibe/compiler/coverage_compile_vibe_sources.vibe,vibe/compiler/selfhost_library_smoke_test.vibe,vibe/x/semver/semver_test.vibe}"
