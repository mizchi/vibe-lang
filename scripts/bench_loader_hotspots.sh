...
COLLECT_BENCH_FILE="${VIBE_LOADER_COLLECT_BENCH_FILE:-$ROOT_DIR/lib/@vibe/compiler/selfhost_loader_collect_bench.vibe}"
GROUP_MATERIALIZE_BENCH_FILE="${VIBE_LOADER_GROUP_MATERIALIZE_BENCH_FILE:-$ROOT_DIR/lib/@vibe/compiler/selfhost_loader_materialize_bench.vibe}"
LIST_MATERIALIZE_BENCH_FILE="${VIBE_LOADER_LIST_MATERIALIZE_BENCH_FILE:-$ROOT_DIR/lib/@vibe/compiler/selfhost_loader_list_materialize_bench.vibe}"
