...
COLLECT_BENCH_FILE="${VIBE_SELFHOST_LOADER_COLLECT_BENCH_FILE:-$ROOT_DIR/lib/@vibe/compiler/loader_collect_bench.vibe}"
GROUP_MATERIALIZE_BENCH_FILE="${VIBE_SELFHOST_LOADER_GROUP_MATERIALIZE_BENCH_FILE:-$ROOT_DIR/lib/@vibe/compiler/loader_materialize_bench.vibe}"
LIST_MATERIALIZE_BENCH_FILE="${VIBE_SELFHOST_LOADER_LIST_MATERIALIZE_BENCH_FILE:-$ROOT_DIR/lib/@vibe/compiler/loader_list_materialize_bench.vibe}"
