...
ALLOWLIST_FILE="${VIBE_SELFHOST_TYPECHECK_FIXTURE_ALLOWLIST_FILE:-$PROJECT_ROOT/bench/check_parity/typecheck_allowed_diff_patterns.txt}"
SNAPSHOT_FILE="${VIBE_SELFHOST_TYPECHECK_FIXTURE_SNAPSHOT_FILE:-$PROJECT_ROOT/bench/golden/typecheck_fixture_parity_snapshot.json}"
