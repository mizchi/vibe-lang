...
//
// Usage:
//   node scripts/bench_selfhost_rc.mjs <module.wasm> [invoke=main] [repeats=7] [args...]
...
if (!wasmPath) {
  console.error("usage: node bench_selfhost_rc.mjs <module.wasm> [invoke] [repeats] [args...]");
  process.exit(2);
}
