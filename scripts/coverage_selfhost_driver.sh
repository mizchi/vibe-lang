...
#
#   scripts/coverage_selfhost_driver.sh    # merges into _build/coverage/selfhost-corpus/acc.json
set -euo pipefail
...
[ -s "$ACC" ] || { echo "driver: corpus acc not found; run coverage_selfhost_corpus.sh first" >&2; exit 1; }
