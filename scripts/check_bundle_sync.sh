...
EXPECTED="${VIBE_BUNDLE_EXPECTED:-$COMPILER_DIR/compiler_sources_bundle.vibe}"
EXPECTED_ADAPTER="${VIBE_ADAPTER_BUNDLE_EXPECTED:-$COMPILER_DIR/cli_adapter_bundle.vibe}"
...
TMP_OUT="$TMP_ROOT/compiler_sources_bundle.vibe"
