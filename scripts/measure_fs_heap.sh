...
unset VIBE_WASM_PRE_GROW_PAGES VIBE_WASM_HOST_ALLOC_MODE \
  ...
  VIBE_INGESTION_TELEMETRY_NONCE VIBE_INGESTION_PIPELINE_TELEMETRY_OUT \
  VIBE_INGESTION_PIPELINE_TELEMETRY_NONCE VIBE_INCREMENTAL_TELEMETRY_OUT \
...
run_compile() {
  ...
  exec env \
    ...
    -u VIBE_INGESTION_PIPELINE_TELEMETRY_OUT \
    -u VIBE_INGESTION_PIPELINE_TELEMETRY_NONCE \
