...
# coverage_selfhost_merge.sh (which is the small fixed compile/normalize/rc set).
#
#   scripts/coverage_selfhost_corpus.sh [dir-or-file ...]   # default: examples fixtures
#   VIBE_COV_MAX=200 scripts/coverage_selfhost_corpus.sh    # cap number of files
