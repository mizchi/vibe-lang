...
BACKEND="${VIBE_SELFHOST_CACHE_PROBE_BACKEND:-interpreter}"
...
cmd_multi_dep="VIBE_TEST_BACKEND=$BACKEND \"$CLI_BIN\" test \"$ROOT_DIR/vibe/compiler/cache_probe_type_db_fs_multi_dep_bench_test.vibe\" >/dev/null"
cmd_cli_prepare="VIBE_TEST_BACKEND=$BACKEND \"$CLI_BIN\" test \"$ROOT_DIR/vibe/compiler/cache_probe_cli_prepare_batch_bench_test.vibe\" >/dev/null"
