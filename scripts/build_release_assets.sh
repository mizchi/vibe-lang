...
# scripts/fetch_compiler.sh and docs/selfhost-bootstrap.md.
...
sh_tmp="$(mktemp -d)"
if ! VIBE_SELFHOST_BUNDLE_OUT="$sh_tmp/sources_bundle.vibe" \
  VIBE_SELFHOST_ADAPTER_BUNDLE_OUT="$sh_tmp/cli_adapter_bundle.vibe" \
