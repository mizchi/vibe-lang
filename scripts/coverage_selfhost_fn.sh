...
#
#   scripts/coverage_selfhost_fn.sh                 # workload: self-compile the compiler (default)
#   scripts/coverage_selfhost_fn.sh path/to/foo.vibe  # workload: compile foo.vibe (FS mode)
#   VIBE_COV_SHOW_MISSED=1 scripts/coverage_selfhost_fn.sh   # also list missed functions
#
...
SEED="${VIBE_COV_SEED:-$ROOT_DIR/bootstrap/selfhost/seed/selfhost_compiler.wasm}"
