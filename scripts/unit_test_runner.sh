...
EXCLUDE_PATTERNS=(
  # These RC regressions run in dedicated compiler gates with their own
  # compiler settings; their inspect expectations live in the source.
