...
case "$shard" in
  ...
  coverage)
    ...
    VIBE_SELFHOST_SUITE_MIN_POINT_RATE="${VIBE_SELFHOST_SUITE_MIN_POINT_RATE:-34}" \
    ...
    VIBE_SELFHOST_SUITE_MIN_FN_HIT="${VIBE_SELFHOST_SUITE_MIN_FN_HIT:-2200}" \
    VIBE_SELFHOST_SUITE_MIN_BRANCH_HIT="${VIBE_SELFHOST_SUITE_MIN_BRANCH_HIT:-3750}" \
