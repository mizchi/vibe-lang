...
case "$shard" in
  ...
  coverage)
    ...
    VIBE_SELFHOST_SUITE_MIN_POINT_RATE="${VIBE_SELFHOST_SUITE_MIN_POINT_RATE:-35}" \
    VIBE_SELFHOST_SUITE_MIN_LINE_RATE="${VIBE_SELFHOST_SUITE_MIN_LINE_RATE:-97}" \
    VIBE_SELFHOST_SUITE_MIN_BRANCH_RATE="${VIBE_SELFHOST_SUITE_MIN_BRANCH_RATE:-9}" \
    VIBE_SELFHOST_SUITE_MIN_FN_HIT="${VIBE_SELFHOST_SUITE_MIN_FN_HIT:-2100}" \
    VIBE_SELFHOST_SUITE_MIN_BRANCH_HIT="${VIBE_SELFHOST_SUITE_MIN_BRANCH_HIT:-3400}" \
