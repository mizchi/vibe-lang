  ...
  modules: [
    {
      ...
      persistent_type_env_transport_fingerprint_kind: "compact_string_fingerprint(persistent_type_env_cache_text:v8 complete TypeEnv transport only; not CheckedProgram, typed IR, exported interface, cache key, or reuse decision)",
      decision: "reused",
    },
  ],
  aggregate_telemetry: {
...
test("private dependency classifier is explicit, fail-closed, and reports TypeEnv-v8 separately", () => {
  const before = plannerTrace();
