...
CASES_FILE="${VIBE_SELFHOST_KPI_CASES_FILE:-$PROJECT_ROOT/bench/selfhost_perf/kpi_cases.txt}"
...
TARGET_COMPILE_RATIO="${VIBE_SELFHOST_KPI_TARGET_COMPILE:-1.5}"
TARGET_CHECK_RATIO="${VIBE_SELFHOST_KPI_TARGET_CHECK:-1.5}"
