...
fn test_state_effect_simulation() {
    ...
    let state_code = r#"((fn (state) (list (+ state 1) (+ state 1))) 0)"#;
...
fn test_effect_polymorphism() {
    ...
    let poly_effect = r#"((fn (f) (fn (x) (f x))) (fn (x) (* x 2)))"#;
...
fn test_effect_inference() {
    ...
    let infer_code = r#"((fn (f g) (fn (x) (f (g x)))) (fn (x) (+ x 1)) (fn (x) x))"#;
...
fn test_effect_handlers_preparation() {
    ...
    let handler_code = r#"((fn (handler comp) (handler comp)) (fn (x) x) (fn () 42))"#;
...
fn test_resource_effect_simulation() {
    ...
    let resource_code = r#"((fn (acquire release use) ((fn (resource) ((fn (result) result) (use resource))) (acquire))) (fn () 1) (fn (c) c) (fn (c) (+ c 10)))"#;
...
fn test_continuation_effect_prep() {
    ...
    let cont_code = r#"((fn (f) (f (fn (x) x))) (fn (k) (+ 1 (k 42))))"#;
...
fn test_simple_effect_composition() {
    ...
    let comp_code = r#"((fn (x) ((fn (y) (+ x y)) 10)) 5)"#;
