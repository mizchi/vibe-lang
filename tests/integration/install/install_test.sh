#!/usr/bin/env bash
# Integration test for the `vibe` install slice (docs/user/getting-started/install.md):
...
# only (docs/user/getting-started/install.md "Install layout").
...
# Dependencies (#2676, docs/user/getting-started/install.md "Dependencies"): `vibe add
...
# Two toolchains in one home (#2677, docs/user/getting-started/install.md "Install layout"): each
