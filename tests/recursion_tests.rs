...
"#;
    ...
    fn test_simple_rec_application() {
        ...
        test_with_file("simple_rec_apply", r#"
((rec double (x) (* x 2)) 21)
"#, |stdout, _, success| {
            assert!(success);
            assert!(stdout.contains("42"));
...
"#;
    ...
    fn test_direct_recursion_application() {
        ...
        test_with_file("direct_rec_apply", r#"
((rec countdown (n)
  (if (= n 0)
      0
      (countdown (- n 1))))
...
"#;
    ...
    fn test_factorial_application() {
        ...
        test_with_file("factorial_apply", r#"
((rec factorial (n : Int) : Int
  (if (= n 0)
      1
      (* n (factorial (- n 1)))))
...
"#, |stdout, _, success| {
    ...
    fn test_factorial_inline_condition() {
        // From debug_rec.xs
        test_with_file("factorial_inline", r#"
...
"#;
    ...
    fn test_rec_debug_application() {
        ...
        test_with_file("rec_debug_apply", r#"
((rec f (n)
  (if (= n 0)
      1
      (f (- n 1))))
