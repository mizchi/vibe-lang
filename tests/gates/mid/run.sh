...
if [ "$gchb_out" != "gc-host-builtins:101010102021010" ]; then
  echo "[compiler-gate] FAIL: gc host builtin probe returned '$gchb_out' (want gc-host-builtins:101010102021010) on both lanes (#1262)" >&2
  exit 1
fi
