...
env VIBE_RC=0 VIBE_PREOPEN_DIR="$PWD" VIBE_SELFHOST_IMPORT_ABI=raw \
  ...
  vibe/compiler/selfhost_cli_adapter_module_source.vibe _build/gc538/stage2e.wasm cli_main
...
env VIBE_BACKEND=gc VIBE_RC=0 VIBE_PREOPEN_DIR="$PWD" VIBE_SELFHOST_IMPORT_ABI=raw \
  ...
  vibe/compiler/selfhost_cli_adapter_module_source.vibe _build/gc538/bundle_gc.wasm cli_main
