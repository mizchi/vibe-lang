...
| `pure-data` | `vibe/std/list.vibe`, `vibe/std/option.vibe`, `vibe/std/result.vibe`, `vibe/std/bytes.vibe`, `vibe/std/threads/spec.vibe` | Pure data structures and transforms |
