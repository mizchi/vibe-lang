...
| [internal/design/naming-convention-migration.md](internal/design/naming-convention-migration.md) | `internal/design/` | ADR-0083, proposed, Phase 0 not started |
| [internal/design/perceus-reuse.md](internal/design/perceus-reuse.md) | `internal/design/` | ADR-0092, proposed |
| [internal/design/qualified-constructor-migration.md](internal/design/qualified-constructor-migration.md) | `internal/design/` | ADR-0096 |
...
| [internal/design/zero-alloc-check.md](internal/design/zero-alloc-check.md) | `internal/design/` | ADR-0091, proposed |
