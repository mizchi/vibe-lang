use crate::{PackageHash, manifest::PackageManifest, PackageError, Result, utils::copy_dir_all};
...
impl crate::resolver::PackageRegistry for LocalRegistry {
...
impl crate::resolver::PackageRegistry for HttpRegistry {
...
mod tests {
    ...
    fn test_local_registry() -> Result<()> {
        ...
        // Calculate hash
        let hash = crate::hash::calculate_package_hash(&package_dir)?;
