...
(module Calculator
  ...
  (let square (fn (x: Int) (* x x))))"#;
    ...
    let module_path = temp_dir.path().join("calculator.vibe");
...
(module SimpleAPI
  ...
  (let process-data (fn (input: String) input)))"#;
    ...
    let temp_dir = TempDir::new().unwrap();
    let module_path = temp_dir.path().join("api.vibe");
...
(module DataProcessor
  ...
  (let aggregate (fn (a: Int b: Int) (+ a b))))"#;
    ...
    let temp_dir = TempDir::new().unwrap();
    let module_path = temp_dir.path().join("processor.vibe");
...
(module ComplexModule
  ...
  (let processInt (fn (x: Int) (+ x 1))))"#;
    ...
    let temp_dir = TempDir::new().unwrap();
    let module_path = temp_dir.path().join("complex.vibe");
...
(module NamingTest
  ...
  (let subtract (fn () 2)))"#;
    ...
    let temp_dir = TempDir::new().unwrap();
    let module_path = temp_dir.path().join("naming.vibe");
