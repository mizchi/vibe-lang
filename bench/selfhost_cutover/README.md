...
`bench/selfhost_cutover/fail_cases.txt` は、`scripts/test_selfhost_cutover_compare.sh` が使う
...
bench/selfhost_cutover/cases/unknown_name.vibe	type	unknown name: foo	0
...
2. `scripts/test_selfhost_cutover_compare.sh` を実行
3. `scripts/test_selfhost_cutover_gate.sh` を実行
