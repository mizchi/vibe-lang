...
English version: [02_a_small_program.vibe.md](../en/02_a_small_program.vibe.md) (canonical)
...
ライブラリ関数にして export し、[モジュール](09_modules_packages.vibe.md) が
やっているように `fn main` から import する。

次章: [値と関数](03_values_functions.vibe.md)。
