...
- [Installation and Hello, vibe](en/01_getting_started.vibe.md)
- [A small program](en/02_a_small_program.vibe.md)

## Common Programming Concepts

- [Values and functions](en/03_values_functions.vibe.md)
- [Control flow](en/04_control_flow.vibe.md)
- [Types and strings](en/05_types_strings.vibe.md)

## Mutation and Regions

- [Mutation, regions, and escape](en/06_mutation.vibe.md)
...
- [Generics, traits, and derive](en/15_generics.vibe.md)
- [Equality](en/16_equality.vibe.md)

## Concurrent Programs

- [Concurrency](en/17_concurrency.vibe.md)

## Tooling and Targets

- [The CLI as an IDE](en/18_cli.vibe.md)
- [Targeting wasm](en/19_wasm.vibe.md)

## Appendix

- [Pitfalls](en/20_pitfalls.vibe.md)
- [Where to look next](en/99_appendix.md)
