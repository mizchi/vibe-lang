...
#
# Two modes (docs/user/getting-started/install.md "Installer options", #2678):
#
...
#   $VIBE_HOME/cache/...
#
# Each toolchain carries its own stdlib (docs/user/getting-started/install.md "Install layout",
...
# mix the two layouts (docs/user/getting-started/install.md "Install layout", #2677).
refuse_flat_home() {
...
# VIBE_HOME exported (docs/user/getting-started/install.md "Install layout").
write_dispatcher() {
...
# 4b. toolchain manifest (docs/user/getting-started/install.md "Install layout", #2677) ----------
...
# own lib/ (docs/user/getting-started/install.md "Install layout", #2677): the launcher puts
