...
the full contract), pipeline combinators over `F[_]` before 0.1.0 (ADR-0110,
#2269) with eager `Array::*` / pull `AsyncIter` as the two-layer lowering
(ADR-0099, #1559), and `Exception` as the truth with `Error`
